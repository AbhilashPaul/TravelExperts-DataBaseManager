...
public class HomeController {
    ...
    public void setUser(Agent agent) throws FileNotFoundException { // Setting the client-object in ClientViewController
        this.agent = agent;
        txtAgentName.setText(agent.getAgentFirstName()+" "+agent.getAgentLastName());
        //Image image = new Image(new FileInputStream("../images/janet_tn.jpg"));
        //agentImage.setImage(image);
    }
