...
public class LoginController {
    ...
    private void createAgentObject(String username) {
        ...
        Agent loggedinAgent = AgentDBHandler.getAgentDetailsByUsername(username);
        if(loggedinAgent != null){
            //save the agent object as global user variable
            TravelExpertsApp.setUser(loggedinAgent);
        }else{
            new Alert(Alert.AlertType.ERROR, "Invalid Username/Password. Please try again!").showAndWait();
        }
    }
